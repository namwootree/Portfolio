...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_file", default='data/ubuntu_data', type=str)
    parser.add_argument("--dev_file", default='data/ubuntu_data', type=str)
    parser.add_argument("--test_file", default='data/ubuntu_data', type=str)
    ...
    if not args.eval:
        ...
        val_dataset = SelectionDataset(os.path.join(args.train_dir, args.dev_file),
    ...
    if args.use_pretrain and not args.eval:
        ...
        bert = BertModel.from_pretrained(model_name, config=bert_config, state_dict=model_state_dict)
